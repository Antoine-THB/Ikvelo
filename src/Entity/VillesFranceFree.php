 ...
 * VillesFranceFree
 *
 * @ORM\Table(name="villes_france_free", uniqueConstraints={@ORM\UniqueConstraint(name="ville_code_commune_2", columns={"ville_code_commune"}), @ORM\UniqueConstraint(name="ville_slug", columns={"ville_slug"})}, indexes={@ORM\Index(name="ville_nom_metaphone", columns={"ville_nom_metaphone"}), @ORM\Index(name="ville_longitude_latitude_deg", columns={"ville_longitude_deg", "ville_latitude_deg"}), @ORM\Index(name="ville_nom_reel", columns={"ville_nom_reel"}), @ORM\Index(name="ville_population_2010", columns={"ville_population_2010"}), @ORM\Index(name="ville_code_commune", columns={"ville_code_commune"}), @ORM\Index(name="ville_departement", columns={"ville_departement"}), @ORM\Index(name="ville_nom_simple", columns={"ville_nom_simple"}), @ORM\Index(name="ville_nom_soundex", columns={"ville_nom_soundex"}), @ORM\Index(name="ville_code_postal", columns={"ville_code_postal"}), @ORM\Index(name="ville_nom", columns={"ville_nom"})})
 * @ORM\Entity
 */
class VillesFranceFree
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="ville_departement", type="string", length=3, nullable=true, options={"default"="NULL"})
     */
    private $villeDepartement = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="ville_slug", type="string", length=255, nullable=true, options={"default"="NULL"})
     */
    private $villeSlug = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="ville_nom", type="string", length=45, nullable=true, options={"default"="NULL"})
     */
    private $villeNom = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="ville_nom_simple", type="string", length=45, nullable=true, options={"default"="NULL"})
     */
    private $villeNomSimple = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="ville_nom_reel", type="string", length=45, nullable=true, options={"default"="NULL"})
     */
    private $villeNomReel = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="ville_nom_soundex", type="string", length=20, nullable=true, options={"default"="NULL"})
     */
    private $villeNomSoundex = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="ville_nom_metaphone", type="string", length=22, nullable=true, options={"default"="NULL"})
     */
    private $villeNomMetaphone = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="ville_code_postal", type="string", length=255, nullable=true, options={"default"="NULL"})
     */
    private $villeCodePostal = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="ville_commune", type="string", length=3, nullable=true, options={"default"="NULL"})
     */
    private $villeCommune = 'NULL';
     ...
     * @var int|null
     *
     * @ORM\Column(name="ville_arrondissement", type="smallint", nullable=true, options={"default"="NULL","unsigned"=true})
     */
    private $villeArrondissement = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="ville_canton", type="string", length=4, nullable=true, options={"default"="NULL"})
     */
    private $villeCanton = 'NULL';

    /**
     * @var int|null
     *
     * @ORM\Column(name="ville_amdi", type="smallint", nullable=true, options={"default"="NULL","unsigned"=true})
     */
    private $villeAmdi = 'NULL';

    /**
     * @var int|null
     *
     * @ORM\Column(name="ville_population_2010", type="integer", nullable=true, options={"default"="NULL","unsigned"=true})
     */
    private $villePopulation2010 = 'NULL';

    /**
     * @var int|null
     *
     * @ORM\Column(name="ville_population_1999", type="integer", nullable=true, options={"default"="NULL","unsigned"=true})
     */
    private $villePopulation1999 = 'NULL';

    /**
     * @var int|null
     *
     * @ORM\Column(name="ville_population_2012", type="integer", nullable=true, options={"default"="NULL","unsigned"=true,"comment"="approximatif"})
     */
    private $villePopulation2012 = 'NULL';

    /**
     * @var int|null
     *
     * @ORM\Column(name="ville_densite_2010", type="integer", nullable=true, options={"default"="NULL"})
     */
    private $villeDensite2010 = 'NULL';

    /**
     * @var float|null
     *
     * @ORM\Column(name="ville_surface", type="float", precision=10, scale=0, nullable=true, options={"default"="NULL"})
     */
    private $villeSurface = 'NULL';

    /**
     * @var float|null
     *
     * @ORM\Column(name="ville_longitude_deg", type="float", precision=10, scale=0, nullable=true, options={"default"="NULL"})
     */
    private $villeLongitudeDeg = 'NULL';

    /**
     * @var float|null
     *
     * @ORM\Column(name="ville_latitude_deg", type="float", precision=10, scale=0, nullable=true, options={"default"="NULL"})
     */
    private $villeLatitudeDeg = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="ville_longitude_grd", type="string", length=9, nullable=true, options={"default"="NULL"})
     */
    private $villeLongitudeGrd = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="ville_latitude_grd", type="string", length=8, nullable=true, options={"default"="NULL"})
     */
    private $villeLatitudeGrd = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="ville_longitude_dms", type="string", length=9, nullable=true, options={"default"="NULL"})
     */
    private $villeLongitudeDms = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="ville_latitude_dms", type="string", length=8, nullable=true, options={"default"="NULL"})
     */
    private $villeLatitudeDms = 'NULL';

    /**
     * @var int|null
     *
     * @ORM\Column(name="ville_zmin", type="integer", nullable=true, options={"default"="NULL"})
     */
    private $villeZmin = 'NULL';

    /**
     * @var int|null
     *
     * @ORM\Column(name="ville_zmax", type="integer", nullable=true, options={"default"="NULL"})
     */
    private $villeZmax = 'NULL';
