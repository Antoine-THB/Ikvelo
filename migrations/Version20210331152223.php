 ...
 */
final class Version20210331152223 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE parcours ADD id_type_trajet INT DEFAULT NULL, DROP velo_uniq, CHANGE id_salarie id_salarie INT DEFAULT NULL, CHANGE id_mois id_mois INT DEFAULT NULL, CHANGE cloture cloture TINYINT(1) NOT NULL, CHANGE validation validation TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE parcours ADD velo_uniq TINYINT(1) DEFAULT \'0\' NOT NULL COMMENT \'utilisation du velo uniquement (oui/non)\', DROP id_type_trajet, CHANGE id_mois id_mois INT NOT NULL, CHANGE id_salarie id_salarie INT NOT NULL, CHANGE cloture cloture TINYINT(1) DEFAULT \'0\' NOT NULL, CHANGE validation validation TINYINT(1) DEFAULT \'0\' NOT NULL');
