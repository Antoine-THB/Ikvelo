 ...
 */
final class Version20210420081453 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE remboursement_abonnement  (id INT AUTO_INCREMENT NOT NULL, id_abonnement INT DEFAULT NULL, montant DOUBLE PRECISION NOT NULL, date DATE NOT NULL, INDEX fk_abonnement (id_abonnement), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE remboursement_abonnement  ADD CONSTRAINT FK_653C42999098E86C FOREIGN KEY (id_abonnement) REFERENCES abonnement (id)');
        $this->addSql('ALTER TABLE abonnement CHANGE id_salarie id_salarie INT DEFAULT NULL');
        $this->addSql('ALTER TABLE abonnement ADD CONSTRAINT FK_351268BB5C13936A FOREIGN KEY (id_salarie) REFERENCES salarie (id)');
        ...
        $this->addSql('ALTER TABLE salarie CHANGE id_ville id_ville INT DEFAULT NULL, CHANGE id_entreprise id_entreprise INT DEFAULT NULL, CHANGE id_service id_service INT DEFAULT NULL, CHANGE id_role id_role INT DEFAULT NULL, CHANGE distance distance NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE url_geovelo url_geovelo VARCHAR(255) DEFAULT \'NULL\', CHANGE created created DATETIME DEFAULT \'current_timestamp()\' NOT NULL, CHANGE updated updated DATETIME DEFAULT \'current_timestamp()\' NOT NULL, CHANGE actif actif TINYINT(1) NOT NULL, CHANGE tps_travail tps_travail INT NOT NULL');
        $this->addSql('ALTER TABLE ticket_journalier CHANGE id_salarie id_salarie INT DEFAULT NULL, CHANGE indemnisation indemnisation DOUBLE PRECISION NOT NULL, CHANGE validation validation TINYINT(1) NOT NULL');
        $this->addSql('ALTER TABLE ticket_journalier ADD CONSTRAINT FK_A99A79295C13936A FOREIGN KEY (id_salarie) REFERENCES salarie (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE remboursement_abonnement ');
        $this->addSql('ALTER TABLE abonnement DROP FOREIGN KEY FK_351268BB5C13936A');
        $this->addSql('ALTER TABLE abonnement CHANGE id_salarie id_salarie INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE salarie CHANGE id_ville id_ville INT NOT NULL, CHANGE id_service id_service INT NOT NULL, CHANGE id_entreprise id_entreprise INT NOT NULL, CHANGE id_role id_role INT NOT NULL, CHANGE distance distance NUMERIC(10, 2) DEFAULT NULL, CHANGE url_geovelo url_geovelo VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_general_ci`, CHANGE created created DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE updated updated DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE actif actif TINYINT(1) DEFAULT \'0\' NOT NULL, CHANGE tps_travail tps_travail INT DEFAULT 100 NOT NULL');
        $this->addSql('ALTER TABLE ticket_journalier DROP FOREIGN KEY FK_A99A79295C13936A');
        $this->addSql('ALTER TABLE ticket_journalier CHANGE id_salarie id_salarie INT NOT NULL, CHANGE indemnisation indemnisation INT NOT NULL, CHANGE validation validation TINYINT(1) DEFAULT \'0\' NOT NULL');
